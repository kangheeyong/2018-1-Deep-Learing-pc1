...
def mnist_matlab_4by4_save(samples,path):
    ...
    mat = {'im_01':np.resize(samples[0],(128,128)),'im_02':np.resize(samples[1],(128,128)),'im_03':np.resize(samples[2],(128,128)),
          'im_04':np.resize(samples[3],(128,128)),'im_05':np.resize(samples[4],(128,128)),'im_06':np.resize(samples[5],(128,128)),
          'im_07':np.resize(samples[6],(128,128)),'im_08':np.resize(samples[7],(128,128)),'im_09':np.resize(samples[8],(128,128)),
          'im_10':np.resize(samples[9],(128,128)),'im_11':np.resize(samples[10],(128,128)),'im_12':np.resize(samples[11],(128,128)),
          'im_13':np.resize(samples[12],(128,128)),'im_14':np.resize(samples[13],(128,128)),'im_15':np.resize(samples[14],(128,128)),
          'im_16':np.resize(samples[15],(128,128))}
